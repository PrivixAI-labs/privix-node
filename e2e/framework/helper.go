...
import (
	...
	"github.com/PrivixAI-labs/Privix-node/contracts/abis"
...
func NewTestServers(t *testing.T, num int, conf func(*TestServerConfig)) []*TestServer {
	...
	// is called for the Dev consensus mode, and privix ibft servers are initialized with NewIBFTServersManager.
