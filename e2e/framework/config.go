...
type TestServerConfig struct {
	...
	IBFTDirPrefix           string                   // The prefix of data directory for privix ibft
	IBFTDir                 string                   // The name of data directory for privix ibft
	...
	EpochSize               uint64                   // The epoch size in blocks for the privix ibft layer
	...
	IsPos                   bool                     // Specifies the mechanism used for privix ibft (PoA / PoS)
	...
	IBFTBaseTimeout         uint64                   // Base Timeout in seconds for privix ibft
...
// SetIBFTPoS sets the flag indicating the privix ibft mechanism
func (t *TestServerConfig) SetIBFTPoS(value bool) {
	t.IsPos = value
}

// SetIBFTDirPrefix callback sets prefix of privix ibft directories
func (t *TestServerConfig) SetIBFTDirPrefix(ibftDirPrefix string) {
	t.IBFTDirPrefix = ibftDirPrefix
}

// SetIBFTDir callback sets the name of data directory for privix ibft
