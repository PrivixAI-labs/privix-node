...
import (
	...
	ibftSwitch "github.com/PrivixAI-labs/Privix-node/command/NLG-ibft/switch"
...
func (t *TestServer) SecretsInit() (*InitIBFTResult, error) {
	...
	// Generate the privix ibft validator private key
...
func (t *TestServer) GenerateGenesis() error {
	...
	case ConsensusIBFT:
		...
		if t.Config.IBFTDirPrefix == "" {
			return errors.New("prefix of privix ibft directory is not set")
		}
