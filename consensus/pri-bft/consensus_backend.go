...
// DISCLAIMER: privix ibft will be deprecated so we set 1 as a voting power to all validators
...
func (i *backendIBFT) buildBlock(parent *types.Header) (*types.Block, error) {
	...
	// (for the privix ibft consensus, it is correct to have just a header, as only it is used)
