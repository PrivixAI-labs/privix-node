...
// Signer is responsible for signing for blocks and messages in privix ibft
...
// GetIBFTExtra extracts privix ibft Extra from the given header
...
// WriteProposerSeal signs and set ProposerSeal into privix ibft Extra of the header
...
func (s *SignerImpl) CreateCommittedSeal(hash []byte) ([]byte, error) {
	return s.keyManager.SignCommittedSeal(
		// Of course, this keccaking of an extended array is not according to the privix ibft 2.0 spec,
...
// WriteCommittedSeals builds and writes CommittedSeals into privix ibft Extra of the header
...
// VerifyCommittedSeals verifies CommittedSeals in privix ibft Extra of the header
...
// VerifyParentCommittedSeals verifies ParentCommittedSeals in privix ibft Extra of the header
...
// CalculateHeaderHash calculates header hash for privix ibft Extra
...
// GetParentCommittedSeals extracts Parent Committed Seals from privix ibft Extra in Header
...
// filterHeaderForHash removes unnecessary fields from privix ibft Extra of the header
...
func (s *SignerImpl) FilterHeaderForHash(header *types.Header) (*types.Header, error) {
	...
	// This will effectively remove the Seal and CommittedSeals from the privix ibft Extra of header,
