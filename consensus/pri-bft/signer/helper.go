...
import (
	...
	"github.com/PrivixAI-labs/Privix-node/helper/keccak"
	"github.com/PrivixAI-labs/Privix-node/secrets"
	"github.com/PrivixAI-labs/Privix-node/secrets/helper"
...
// calculateHeaderHash is hash calculation of header for privix ibft
...
// verifyIBFTExtraSize checks whether header.ExtraData has enough size for privix ibft Extra
