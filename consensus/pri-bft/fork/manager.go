...
import (
	...
	"github.com/PrivixAI-labs/Privix-node/consensus/pri-bft/hook"
	...
	"github.com/PrivixAI-labs/Privix-node/validators/store/contract"
)
...
// HooksInterface is an interface of hooks to be called by privix ibft
