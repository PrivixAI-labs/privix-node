...
var (
	...
	ErrIBFTConfigNotFound            = errors.New(`"pribft" config doesn't exist in "engine" of genesis.json'`)
	ErrSameIBFTAndValidatorType      = errors.New("cannot specify same privix ibft type and validator type as the last fork")
