...
type Config struct {
	...
	JSONRPCAuthToken         string     `json:"json_rpc_auth_token" yaml:"json_rpc_auth_token"`
	JSONRPCAllowlist         []string   `json:"json_rpc_allowlist" yaml:"json_rpc_allowlist"`
...
const (
	// BlockTimeMultiplierForTimeout Multiplier to get privix ibft timeout from block time
	// timeout is calculated when privix ibft timeout is not specified
