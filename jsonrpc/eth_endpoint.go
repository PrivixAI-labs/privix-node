...
// Privix core don't have any support for eth_accounts (current end point is not functional ) just added this dummy to turn neth compatible for all ethereum tools
...
func (e *Eth) GetBlockByNumber(number BlockNumber, fullTx bool) (interface{}, error) {
	...
	nullAddress := types.StringToAddress("0x0000000000000000000000000000000000000000")
