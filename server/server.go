...
import (
	...
	"github.com/PrivixAI-labs/Privix-node/blockchain/storage/leveldb"
	"github.com/PrivixAI-labs/Privix-node/blockchain/storage/memory"

	//consensusPolyBFT
	"github.com/PrivixAI-labs/Privix-node/gasprice"

	"github.com/PrivixAI-labs/Privix-node/archive"
	...
	//"github.com/PrivixAI-labs/Privix-node/consensus/polybft/statesyncrelayer"
	...
	"github.com/PrivixAI-labs/Privix-node/jsonrpc"
	"github.com/PrivixAI-labs/Privix-node/network"
	"github.com/PrivixAI-labs/Privix-node/secrets"
	"github.com/PrivixAI-labs/Privix-node/server/proto"
	"github.com/PrivixAI-labs/Privix-node/state"
	itrie "github.com/PrivixAI-labs/Privix-node/state/immutable-trie"
	"github.com/PrivixAI-labs/Privix-node/state/runtime"
	"github.com/PrivixAI-labs/Privix-node/state/runtime/addresslist"
	"github.com/PrivixAI-labs/Privix-node/state/runtime/tracer"
	"github.com/PrivixAI-labs/Privix-node/txpool"
	"github.com/PrivixAI-labs/Privix-node/types"
	"github.com/PrivixAI-labs/Privix-node/validate"
...
func (s *Server) setupJSONRPC() error {
	...
	conf := &jsonrpc.Config{
		...
		AuthToken:                s.config.JSONRPC.AuthToken,
		Allowlist:                s.config.JSONRPC.Allowlist,
	}
